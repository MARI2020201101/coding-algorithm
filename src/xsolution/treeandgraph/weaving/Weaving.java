...
class Weaving {
    public static void main(String[] args) {
        ...
        LinkedList<LinkedList<Integer>> allSequences = allSequences(root);
        allSequences.forEach(System.out::println);
    }
    static LinkedList<LinkedList<Integer>> allSequences(Node root){
        ...
        LinkedList<LinkedList<Integer>> leftSequences = allSequences(root.left);
        LinkedList<LinkedList<Integer>> rightSequences = allSequences(root.right);
